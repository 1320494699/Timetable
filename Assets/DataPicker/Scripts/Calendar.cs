...
public class Calendar : UIBehaviour
{
    ...
    [HideInInspector] public E_CalendarType CalendarType = E_CalendarType.Day;
    ...
    private void RefreshTimeButtonContent()
    {
        switch (CalendarType)
        {
            ...
            case E_CalendarType.Month:
                if (DisplayType == E_DisplayType.Standard)
                    _timeButtonText.text = m_selectDT.Year + "/" + m_selectDT.Month;
